...
Public claim boundary: no Pareto frontier, no cloud-dollar claim, no production ARIN22 performance claim, and no NVIDIA-grade crossover claim while reference remains internal, CPU RAPL/cloud cost are missing, or the H100 is unsaturated.
