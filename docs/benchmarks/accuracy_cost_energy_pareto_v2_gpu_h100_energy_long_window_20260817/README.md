...
Public claim boundary: H100 joules are measured for review-only workload rows, but CPU joules, cloud-dollar frontier, external/multi-engine reference and withheld_runtime performance remain locked.
